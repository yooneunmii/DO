...
<body>
	...
	<div id="index">
		<div id="markerWrap">
			<div id="title">
				<span class="check">Main Page</span>
			</div>
			<!-- title end -->
			<div id="realTimeHot">
				<ol id="page1">
	...
	<script>
		...
		$(".profileBox")
				.click(
						function() {
							window
									.open('porfile.jsp', 'user',
											'scrollbars=yes,toolbar=no,resizable=yes,width=250,height=300,left=0,top=0');
						});
...
<%
		...
		response.sendRedirect("indexMarker.jsp");
	}
%>